...
class AIEnglishTutor {
    ...
    initUI() {
        // 按钮
        this.createLessonBtn = document.getElementById('createLessonBtn');
        this.startLessonBtn = document.getElementById('startLessonBtn');
        this.newLessonBtn = document.getElementById('newLessonBtn');
        this.startRecordingBtn = document.getElementById('startRecordingBtn');
        this.stopRecordingBtn = document.getElementById('stopRecordingBtn');
        this.endLessonBtn = document.getElementById('endLessonBtn');
        
        // 输入
        this.lessonText = document.getElementById('lessonText');
        this.imageInput = document.getElementById('imageInput');
        this.imageUpload = document.getElementById('imageUpload');
        this.imagePreview = document.getElementById('imagePreview');
        
        // 显示区域
        this.prepareArea = document.getElementById('prepareArea');
        this.lessonInfoArea = document.getElementById('lessonInfoArea');
        this.welcomeArea = document.getElementById('welcomeArea');
        this.teachingArea = document.getElementById('teachingArea');
    ...
    switchStage(stage) {
        ...
        this.currentStage = stage; // 更新当前阶段
    ...
    stopRecording() {
        ...
        // 只在article阶段（手动模式）停止录音时提交音频并触发响应
        // 其他阶段使用VAD自动检测，不需要手动提交
        if (this.currentStage === 'article' && this.ws && this.ws.readyState === WebSocket.OPEN) {
            this.ws.send(JSON.stringify({ type: 'commit_audio' }));
            console.log('📤 Sent commit_audio (article stage)');
        }
    ...
    async endLesson() {
        if (!confirm('Are you sure you want to end the lesson?')) {
            return;
        }
        ...
        // 显示总结区域
        this.summaryArea.style.display = 'block';
        document.getElementById('summaryContent').innerHTML = 
            'Lesson completed! The AI will provide a summary shortly...';
        
        this.endLessonBtn.disabled = true;
        this.startRecordingBtn.disabled = true;
    }
